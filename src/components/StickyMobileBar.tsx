  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3 px-4 py-3">
        ...
        <a
          href={websiteUrl || "/quiz"}
          {...(websiteUrl ? { target: "_blank", rel: "noopener noreferrer" } : {})}
          className="group flex shrink-0 items-center gap-2 rounded-full bg-ink-900 py-2 pl-5 pr-2 text-[13px] font-medium text-cream-50 transition-transform duration-150 ease-out active:scale-[0.97]"
        >
          {websiteUrl ? "Visit Site" : "Take Quiz"}
