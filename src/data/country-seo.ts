...
export const COUNTRY_SEO: Record<string, CountrySEOData> = {
  ...
  thailand: {
    ...
    country: "Thailand",
    description: [
      "Thailand pioneered the modern wellness retreat industry in Southeast Asia, and its scene remains one of the most sophisticated in the world. From the pristine beaches of Koh Samui and Phuket to the misty mountains of Chiang Mai, Thai retreats blend ancient Buddhist meditation traditions with cutting-edge detox science and world-class spa culture.",
  ...
  portugal: {
    ...
    country: "Portugal",
    description: [
      "Portugal has quietly become Europe's most compelling wellness destination, offering a rare combination of year-round sunshine, Atlantic coastline, affordable luxury, and a laid-back culture that naturally supports wellbeing. The Algarve's dramatic cliff-backed beaches, the Alentejo's rolling cork oak landscapes, and Sintra's mystical forests provide stunning backdrops for retreat experiences.",
  ...
  peru: {
    ...
    description: [
      ...
      "Beyond plant medicine, Peru offers stunning natural settings for wellness at every altitude. The Sacred Valley near Cusco sits at 2,800 meters, providing a dramatic Andean backdrop for yoga retreats and spiritual journeys. The Amazon rainforest offers jungle immersion and traditional medicine. And the Pacific coast delivers surf-wellness combinations in destinations like Mancora.",
  ...
  colombia: {
    ...
    faqItems: [
      ...
      { question: "What are the best wellness destinations in Colombia?", answer: "Medellin and its surroundings lead for urban-accessible wellness. The coffee region (Eje Cafetero) offers farm-stay retreats amid stunning landscapes. Santa Marta and Palomino on the Caribbean coast combine beach with jungle healing. Cartagena provides luxury spa experiences. Villa de Leyva has spiritual retreat centers." },
